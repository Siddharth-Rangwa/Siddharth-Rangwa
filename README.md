...
<img src="https://skillicons.dev/icons?i=python,tensorflow,pytorch,opencv,flask,fastapi,docker,kubernetes,mysql,gcp,git,linux&perline=6" alt="Tech stack icons"/>

<br/><br/>

`Computer Vision` · `LLMs & AI Agents` · `Speech (STT/TTS)` · `Vector Embeddings` · `ONNX Runtime` · `Model Optimization` · `WebSockets` · `REST APIs`
...
![IBM](https://img.shields.io/badge/Python_for_Programmers-IBM_SkillsBuild-052FAD?style=flat&logo=ibm&logoColor=white)
![HF](https://img.shields.io/badge/AI_Agents-Hugging_Face-FFD21E?style=flat&logo=huggingface&logoColor=black)
![Kaggle](https://img.shields.io/badge/Python_Coder-Kaggle-20BEFF?style=flat&logo=kaggle&logoColor=white)
![fCC](https://img.shields.io/badge/Responsive_Web_Design-freeCodeCamp-0A0A23?style=flat&logo=freecodecamp&logoColor=white)
